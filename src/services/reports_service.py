...
def get_date_range(
    period: ReportPeriod, reference_date: date
...
def get_sales_metrics(db: Session, start_date: datetime, end_date: datetime) -> dict:
    """
    ...
    cost_query = (
        db.query(
            func.sum(SaleDetail.quantity * LotDetail.unit_cost).label("total_cost")
        )
